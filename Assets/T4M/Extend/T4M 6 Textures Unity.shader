Shader "T4MShaders/ShaderModel3/Diffuse/T4M 6 Textures Unity" {
Properties {
	...
	_BumpSplat4("Layer4Normalmap", 2D) = "bump" {}
	_BumpSplat5("Layer4Normalmap", 2D) = "bump" {}
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Normal += splat_control2.r * UnpackNormal(tex2D(_BumpSplat4, IN.uv_Splat4));
	o.Normal += splat_control2.b * UnpackNormal(tex2D(_BumpSplat5, IN.uv_Splat5));
